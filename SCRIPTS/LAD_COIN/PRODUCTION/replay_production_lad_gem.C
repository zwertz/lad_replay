...
void replay_production_lad_gem(int RunNumber = 0, int MaxEvent = 0, int run_type = 1, int FirstEvent = 1,
  ...
  REPORTFileNamePattern = "REPORT_OUTPUT/LAD_COIN/PRODUCTION/replayReport_LAD_coin_production_lad_gem_only_%d_%d_%d_%d.report";
  REPORTFileName        = Form(REPORTFileNamePattern, RunNumber, FirstSegment, MaxSegment, MaxEvent);

  ROOTFileNamePattern = "ROOTfiles/LAD_COIN/PRODUCTION/LAD_COIN_lad_gem_only_%d_%d_%d_%d.root";
  ...
  // Define DEF-file
  analyzer->SetOdefFile("DEF-files/LAD_COIN/PRODUCTION/coin_production_lad_gem_only.def");
  // Define cuts file
  analyzer->SetCutFile("DEF-files/LAD_COIN/PRODUCTION/CUTS/coin_production_cuts_lad_gem_only.def"); // optional
